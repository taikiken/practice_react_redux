...
// dev
gulp.task('vendor:libs:dev', () => gulp.src(libs)
...
// build
gulp.task('vendor:libs:build', ['vendor:libs:dev'], () => gulp.src(`${dir.app.root}/**/libs/**/*`)
...
// dev
// 未圧縮結合
gulp.task('vendor:concat:dev', () => gulp.src(
  [
...
gulp.task('vendor:concat:build', () => gulp.src(
  [
...
// copy to dist
gulp.task('vendor:copy', () => gulp.src(
  [
    `${dir.app.root}/**/libs/**/*`,
